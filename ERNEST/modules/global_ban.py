...
from ERNEST.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from ERNEST.modules.helper_funcs.misc import send_to_list
...
def gban(update: Update, context: CallbackContext):
    ...
    if EVENT_LOGS:
        ...
        send_to_list(bot, CHACHA VIDHAYAK + SHETAN, log_message, html=True)
        ...
        try:
            ...
            if excp.message in GBAN_ERRORS:
                ...
                if EVENT_LOGS:
                    ...
                    send_to_list(
                        bot, CHACHA VIDHAYAK + SHETAN, f"Could not gban due to: {excp.message}"
                    )
...
def ungban(update: Update, context: CallbackContext):
    ...
    if EVENT_LOGS:
        ...
        send_to_list(bot, CHACHA VIDHAYAK + SHETAN, "un-gban complete!")
...
def __user_info__(user_id):
    ...
    if user_id == dispatcher.bot.id:
        return ""
    if int(user_id) in CHACHA VIDHAYAK + KUTTE + BHEDIYA:
        return ""
    if is_gbanned:
