...
from ERNESTRoBot import CHACHA VIDHAYAK, dispatcher
from ERNESTRoBot.modules.disable import DisableAbleCommandHandler
from ERNESTRoBot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_pin,
    can_promote,
    connection_status,
...
from ERNESTRoBot.helper_extra.admin_rights import (
    user_can_pin,
    user_can_promote,
    user_can_changeinfo,
)

from ERNESTRoBot.modules.helper_funcs.extraction import (
    extract_user,
    extract_user_and_text,
)
from ERNESTRoBot.modules.log_channel import loggable
from ERNESTRoBot.modules.helper_funcs.alternate import send_message
from ERNESTRoBot.modules.helper_funcs.alternate import typing_action
...
def promote(update: Update, context: CallbackContext) -> str:
    ...
    if (
        ...
        and user.id not in CHACHA VIDHAYAK
    ):
